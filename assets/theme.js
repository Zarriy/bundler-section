...
import { timeline } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { animate, timeline as timeline2, stagger } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { stagger as stagger2 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { animate as animate2, stagger as stagger3, inView } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { inView as inView2 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { scroll } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { timeline as timeline3, inView as inView3 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { animate as animate3 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { animate as animate4 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { Delegate as Delegate2 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
  ...
  async attributeChangedCallback(attribute, oldValue, newValue) {
   ...
   _updateMessage() {
      ...
      if (this.totalPrice >= this.threshold) {
        ...
        if (this.totalPrice >= 7000) {
          const widget2 = document.getElementById("free_gift_widget_2");
          widget2.classList.add("free_gift_show");
          const widget1 = document.getElementById("free_gift_widget_1");
          widget1.classList.remove("free_gift_show");
        }
      } 
      else if(this.totalPrice <= 3900){
        const replacement = `<span class="bold text-accent">${formatMoney( 3900 - this.totalPrice).replace(/\$/g, "$$$$")}</span>`;
        messageElement.innerHTML = this.getAttribute("unreached-message").replace(new RegExp("({{.*}})", "g"), replacement);
        const element = document.getElementById("first");
        element.classList.add("p_show");
      }
      else if(this.totalPrice <= 5400){
        const replacement = `<span class="bold text-accent">${formatMoney(5400 - this.totalPrice).replace(/\$/g, "$$$$")}</span>`;
        messageElement.innerHTML = this.getAttribute("unreached-message").replace(new RegExp("({{.*}})", "g"), replacement);
        const element = document.getElementById("second");
        element.classList.add("p_show");
        
      }
     else if(this.totalPrice <= 6900){
        const replacement = `<span class="bold text-accent">${formatMoney(6900 - this.totalPrice).replace(/\$/g, "$$$$")}</span>`;
        messageElement.innerHTML = this.getAttribute("unreached-message").replace(new RegExp("({{.*}})", "g"), replacement);
        const element = document.getElementById("third");
        element.classList.add("p_show");

       const widget1 = document.getElementById("free_gift_widget_1");
        widget1.classList.add("free_gift_show");
        const widget2 = document.getElementById("free_gift_widget_2");
        widget2.classList.remove("free_gift_show");
...
import { animate as animate5 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { Delegate as Delegate3 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { PhotoSwipeLightbox } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/photoswipe.min.js?v=96595610301167188461684333019"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { inView as inView4 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { timeline as timeline6 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { animate as animate8 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { animate as animate9 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
import { animate as animate10, inView as inView5 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
...
// js/theme.js
import { Delegate as Delegate4 } from "//cdn.shopify.com/s/files/1/0594/0969/4886/t/39/assets/vendor.min.js?v=19330323356122838161684333019";
(() => {
...
class CustomSelectBox extends HTMLElement {
  ...
  updateId(){
    this.closest("product-form").querySelector('input[name="id"]').value = this.currentVariant.id;
  }

  updateButton(){
    if(!this.currentVariant.available){
      this.closest("product-form").querySelector('button[type="submit"]').setAttribute('disabled', 'disabled');
      this.closest("product-form").querySelector('button[type="submit"]').textContent = 'Sold Out';
    }else{
       this.closest("product-form").querySelector('button[type="submit"]').removeAttribute('disabled');
       this.closest("product-form").querySelector('button[type="submit"]').textContent = 'Add to Cart';
    }
  ...
  updateMedia(){
    ...
    const new_scr = this.currentVariant.featured_image.src;
    this.closest('product-card').querySelector('.product-card__figure img').setAttribute('srcset', new_scr );
  }

  updatePrices() {
    const formattedPrice = formatMoney(this.currentVariant.price, currencyFormat);
    this.closest('product-card').querySelector('sale-price').innerHTML = formattedPrice;
  }

}

customElements.define('custom-select-box', CustomSelectBox);
